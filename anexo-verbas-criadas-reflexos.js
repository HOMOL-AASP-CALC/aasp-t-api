...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das verbasCriadas', 
        prefixo: 'verbasCriadas', 
        grupo: 'verbasCriadas',
        id: 3, 
        visivel: 1,
    ...
    this.getValorPlanilha = function(nome, dia, coluna) {
        console.log('passando na função default - anexo-verbas-criadas-reflexos linha 134',nome, dia, coluna)
        return 0;
    }
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            if (l.tipoCalc == 'ap') {
                l.valor = this.getValorPlanilha(this.info.grupo, l.diaInt, 'valor') * (l.proporcao / 30)
                l.strProporcao = l.proporcao + ' dias'
            } else {
                l.valor = this.getValorPlanilha(this.info.grupo, l.diaInt, "valor") * (l.proporcao / 12)
    ...
    this.setReflexo = function(dados) {
        ...
        // console.log('vc-reflexos',d.index, d)
    ...
    if (var1.titulo)  this.info.titulo = var1.titulo + ' - reflexos nas demais verbas'
    if (var1.grupo) this.info.grupo = var1.grupo
    if (var1.prefixo) this.info.prefixo = var1.prefixo //+ 'Reflexos'
