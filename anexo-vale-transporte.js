...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        prefixo: 'valeTransporte', 
        grupo: 'valeTransporte',
        id: 1, 
        visivel: 1,
    ...
    this.colunas = [
        ...
        { titulo: 'Quantidade de vales', tipo: 'v', casas: 2, nome: "quantidade"}, 
        { titulo: 'Valor', tipo: 'v', casas: 2, nome: "valor"},
        { titulo: 'Valor total das conduções', tipo: 'f', casas: 2, nome: "total"},
        { titulo: 'Percentual da dedução', tipo: 'v', casas: 2, nome: "percDeducao"},
        { titulo: 'Valor da dedução', tipo: 'f', casas: 2, nome: "valorDeducao"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            if (typeof l.percDeducao === 'undefined' || l.percDeducao == null) l.percDeducao = 6 
            l.total = l.quantidade * l.valor 
            l.valorDeducao = this.getValorPlanilha('salario', i, "salarioEfetivo") * (l.percDeducao / 100)
            l.resultado = l.total - l.valorDeducao
            if ( l.resultado < 0 ) l.resultado = 0
