...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das horas interjornada nas demais verbas', 
        prefixo: 'horasInterReflexos', 
        grupo: 'horasInter',
        id: 3, 
        visivel: 1,
    ...
    this.colunas = [
        ...
        { titulo: 'Horas interjornada', tipo: 'f', casas: 2, nome: "he"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.salarioHora = this.getValorPlanilha('horasInter', l.diaInt, "salarioHora")
            var calcMedia = this.getMediaPlanilha('horasInterConversao', 'horasNormais',  l.pa_ini, l.pa_fim, true)
