...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das horas interjonada nos DSRs', 
        prefixo: 'horasInterDsr', 
        grupo: 'horasInter',
        id: 1, 
        visivel: 1,
    ...
    this.colunas = [
        ...
        { titulo: 'Horas interjonada', tipo: 'f', casas: 2, nome: "base"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.base = this.getValorPlanilha('horasInter', i, "diferenca")  // base
