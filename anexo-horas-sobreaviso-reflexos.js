...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das horas de sobreaviso nas demais verbas', 
        prefixo: 'horasSobreavisoReflexos', 
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.salarioHora = this.getValorPlanilha('horasSobreaviso', l.diaInt, "salarioHora")
            var calcMedia = this.getMediaPlanilha('horasSobreavisoConversao', 'horasNormais',  l.pa_ini, l.pa_fim, true)
