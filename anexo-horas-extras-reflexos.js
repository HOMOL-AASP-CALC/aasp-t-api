...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das horas extras nas demais verbas', 
        prefixo: 'horasExtrasReflexos', 
        grupo: 'horasExtras',
        id: 3, 
        visivel: 1,
    ...
    this.colunas = [
        ...
        { titulo: 'Horas extras', tipo: 'f', casas: 2, nome: "he"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.salarioHora = this.getValorPlanilha('horasExtras', l.diaInt, "salarioHora")
            var calcMedia = this.getMediaPlanilha('conversaoHEHA', 'he',  l.pa_ini, l.pa_fim, true)
            // console.log("calcMedia", calcMedia, l)
            // console.log('================')
            l.he =  calcMedia.media 
            l.resultadoMedia = calcMedia.media 
            l.itensMedia = calcMedia.itens 
            // console.log('l.itensMedia', l.itensMedia)
