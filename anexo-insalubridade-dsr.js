module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo da insalubridade nos DSRs', 
        prefixo: 'insalubridadeDsr', 
        grupo: 'insalubridade',
        id: 1, 
        visivel: 1,
    ...
    this.colunas = [
        ...
        { titulo: 'Insalubridade', tipo: 'f', casas: 2, nome: "base"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.base = this.getValorPlanilha('insalubridade', i, "diferenca")  // base
