...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Conversão de horas itinere em horas normais', 
        prefixo: 'horasItinereConversao', 
        grupo: 'horasItinere',
        id: 20, 
        visivel: 1,
    ...
    this.calc = function () {
        ...
        var horasItinereMetodo = this.getVariavel('horasItinereMetodo')
        // console.log('horasItinereMetodo',horasItinereMetodo)

        this.colunas = [] 
        this.colunas.push({titulo: 'Data', tipo: 'data',  nome: "dia"})

        this.colunas.push( { titulo: 'Horas in itinere', tipo: 'h', casas: 2, nome: "horas",  modal: "mModoDigitacaoHora"} )
        this.colunas.push( { titulo: 'Percentual', tipo: 'v', casas: 2, nome: "percentual",  modal: "mMetodologiaItinere"} )
        ...
        for (var i in this.planilha) {
            ...
            if (l.horas.length==6) {
                ...
                if (horasItinereMetodo == 'horaPercentual') {
