...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das horas extras nas demais verbas (somente adicional)', 
        prefixo: 'horasExtrasSomenteAdicReflexos', 
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.salarioHora = this.getValorPlanilha('horasExtrasSomenteAdic', l.diaInt, "salarioHora")
            var calcMedia = this.getMediaPlanilha('conversaoHESA', 'he',  l.pa_ini, l.pa_fim, true)
