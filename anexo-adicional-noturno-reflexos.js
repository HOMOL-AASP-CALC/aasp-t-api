...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo do adicional noturno nas demais verbas', 
        prefixo: 'adicionalNoturnoReflexos', 
    ...
    this.colunas = [
        ...
        { titulo: 'Salário hora', tipo: 'f', casas: 2, nome: "salarioHora"},
        { titulo: 'Horas noturnas', tipo: 'f', casas: 2, nome: "he"},
        // { titulo: 'Composição da média', tipo: 'data', nome: "itens"},
    ...
    this.getValorPlanilha = function(nome, dia, coluna) {
        console.log('passando na função default - anexo-adicional-noturno-reflexos linha 59',nome, dia, coluna)
        return 0;
    }
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.salarioHora = this.getValorPlanilha('adicionalNoturno', l.diaInt, "salarioHora")
            var calcMedia = this.getMediaPlanilha('adicionalNoturno', 'totalHorasNoturnas',  l.pa_ini, l.pa_fim, true)
            l.he =  calcMedia.media 
            
            // l.itens = JSON.stringify( calcMedia.itens ) 
            l.resultadoMedia = calcMedia.media 
            l.itensMedia = calcMedia.itens 
            l.valor = l.salarioHora * l.he 

            if (l.tipoCalc == 'ap') {
                l.valor = l.valor * (l.proporcao / 30)
                l.strProporcao = l.proporcao + ' dias'
            } else {
                l.valor = l.valor * (l.proporcao / 12)
