...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das horas in itinere nas demais verbas', 
        prefixo: 'horasItinereReflexos', 
        grupo: 'horasItinere',
        id: 3, 
        visivel: 1,
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.salarioHora = this.getValorPlanilha('horasItinere', l.diaInt, "salarioHora")
            var calcMedia = this.getMediaPlanilha('horasItinereConversao', 'horasNormais',  l.pa_ini, l.pa_fim, true)
