...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Conversão de horas extras em horas normais (somente adicional)', 
        prefixo: 'conversaoHESA', 
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            if (percHE1 && typeof l.he1 !== 'undefined' && l.he1.length==6) {
                ...
                // console.log('anexco-sa - h, m', h,m)
                l.hed += (h + (m/100)) * (  percHE1 / 100)
            }
    ...
    this.set = function(dia, coluna, valor, nao_repetir) {
        if (dia == 'info') {
            ...
            // console.log('++++++++ this.planilha[dia]', JSON.stringify( this.planilha[dia]) )  

            if (typeof this.planilha[dia] === 'undefined') {
                // console.log('deve sair fora')
                return;
            }

            this.planilha[dia][coluna] = valor 
            
            // console.log('this.planilha[dia]', this.planilha[dia])
