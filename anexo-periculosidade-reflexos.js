...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo da periculosidade nas demais verbas', 
        prefixo: 'periculosidadeReflexos', 
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            if (l.tipoCalc == 'ap') {
                l.valor = this.getValorPlanilha('periculosidade', l.diaInt, "valorIntegral") * (l.proporcao / 30)
                l.strProporcao = l.proporcao + ' dias'
            } else {
                l.valor = this.getValorPlanilha('periculosidade', l.diaInt, "valorIntegral") * (l.proporcao / 12)
