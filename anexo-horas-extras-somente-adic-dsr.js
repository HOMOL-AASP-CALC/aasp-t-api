...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das horas extras nos DSRs (somente adicional)', 
        prefixo: 'horasExtrasSomenteAdicDsr', 
    ...
    this.colunas = [
        ...
        { titulo: 'Horas Extras', tipo: 'f', casas: 2, nome: "base"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.base = this.getValorPlanilha('horasExtrasSomenteAdic', i, "diferenca")  // base
