...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo da Insalubridade nas demais verbas', 
        prefixo: 'insalubridadeReflexos', 
        grupo: 'insalubridade',
        id: 3, 
        visivel: 1,
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            if (l.tipoCalc == 'ap') {
                l.valor = this.getValorPlanilha('insalubridade', l.diaInt, "valorIntegral") * (l.proporcao / 30)
                l.strProporcao = l.proporcao + ' dias'
            } else {
                l.valor = this.getValorPlanilha('insalubridade', l.diaInt, "valorIntegral") * (l.proporcao / 12)
