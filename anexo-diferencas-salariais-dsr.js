module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das diferenças salariais nos DSRs', 
        prefixo: 'diferencasSalariaisDsr', 
    ...
    this.colunas = [
        ...
        { titulo: 'Valor das diferenças', tipo: 'f', casas: 2, nome: "base"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.base = this.getValorPlanilha('diferencasSalariais', i, "diferencaEfetiva")  // base
