module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo da equiparação salarial nos DSRs', 
        prefixo: 'equiparacaoSalarialDsr', 
    ...
    this.colunas = [
        ...
        { titulo: 'Valor da Equiparação', tipo: 'f', casas: 2, nome: "base"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.base = this.getValorPlanilha('equiparacaoSalarial', i, "diferenca")  // base
