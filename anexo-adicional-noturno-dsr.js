...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo do adicional noturno nos DSRs', 
        prefixo: 'adicionalNoturnoDsr', 
    ...
    this.colunas = [
        ...
        { titulo: 'Horas noturnas', tipo: 'f', casas: 2, nome: "base"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.base = this.getValorPlanilha('adicionalNoturno', i, "diferenca")  // base
