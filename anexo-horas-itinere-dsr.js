...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das horas in itinete nos DSRs (somente adicional)', 
        prefixo: 'horasItinereDsr', 
        grupo: 'horasItinere',
        id: 1, 
        visivel: 1,
    ...
    this.colunas = [
        ...
        { titulo: 'Valor', tipo: 'f', casas: 2, nome: "base"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.base = this.getValorPlanilha('horasItinere', i, "diferenca")  // base
