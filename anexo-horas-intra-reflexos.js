...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das horas intrajornada nas demais verbas', 
        prefixo: 'horasIntraReflexos', 
        grupo: 'horasIntra',
        id: 3, 
        visivel: 1,
    ...
    this.colunas = [
        ...
        { titulo: 'Horas intrajornada', tipo: 'f', casas: 2, nome: "he"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.salarioHora = this.getValorPlanilha('horasIntra', l.diaInt, "salarioHora")
            var calcMedia = this.getMediaPlanilha('horasIntraConversao', 'horasNormais',  l.pa_ini, l.pa_fim, true)
