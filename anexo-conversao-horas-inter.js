...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Conversão de horas interjornada em horas normais', 
        prefixo: 'horasInterConversao', 
        grupo: 'horasInter',
        id: 20, 
        visivel: 1,
    ...
    this.calc = function () {
        ...
        var horasInterMetodo = this.getVariavel('horasInterMetodo')

        this.colunas = [] 
        this.colunas.push({titulo: 'Data', tipo: 'data',  nome: "dia"})

        this.colunas.push( { titulo: 'Horas interjornada', tipo: 'h', casas: 2, nome: "horas",  modal: "mModoDigitacaoHora"} )
        this.colunas.push( { titulo: 'Percentual', tipo: 'v', casas: 2, nome: "percentual",  modal: "mMetodologiaHorasInter"} )
        ...
        for (var i in this.planilha) {
            ...
            if (l.horas.length==6) {
                ...
                if (horasInterMetodo == 'horaPercentual') {
