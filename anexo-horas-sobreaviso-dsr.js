...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo das horas de sobreaviso nos DSRs', 
        prefixo: 'horasSobreavisoDsr', 
    ...
    this.colunas = [
        ...
        { titulo: 'Horas de sobreaviso', tipo: 'f', casas: 2, nome: "base"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.base = this.getValorPlanilha('horasSobreaviso', i, "diferenca")  // base
