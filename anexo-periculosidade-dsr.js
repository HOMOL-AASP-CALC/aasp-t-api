module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo da periculosidade nos DSRs', 
        prefixo: 'periculosidadeDsr', 
    ...
    this.colunas = [
        ...
        { titulo: 'Periculosidade', tipo: 'f', casas: 2, nome: "base"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.base = this.getValorPlanilha('periculosidade', i, "diferenca")  // base
