module.exports = function(var1) {
    ...
    this.colunas = [
        ...
        { titulo: 'Base', tipo: 'f', casas: 2, nome: "base"},
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            l.base = this.getValorPlanilha(this.info.grupo, i, "diferenca") 
    ...
    if (var1.titulo)  this.info.titulo = var1.titulo + ' - reflexos dos DSRs'
    if (var1.grupo) this.info.grupo = var1.grupo
    if (var1.prefixo) this.info.prefixo = var1.prefixo // + 'Dsr'  
