...
module.exports = function(var1) {
    ...
    this.info = {
        ...
        titulo: 'Reflexo da equiparação salarial nas demais verbas', 
        prefixo: 'equiparacaoSalarialReflexos', 
    ...
    this.calc = function () {
        ...
        for (var i in this.planilha) {
            ...
            if (l.tipoCalc == 'ap') {
                l.valor = this.getValorPlanilha('equiparacaoSalarial', l.diaInt, "diferenca") * (l.proporcao / 30)
                l.strProporcao = l.proporcao + ' dias'
            } else {
                l.valor = this.getValorPlanilha('equiparacaoSalarial', l.diaInt, "diferenca") * (l.proporcao / 12)
            ...
            l.resultadoCalc = l.valor * l.indice 
